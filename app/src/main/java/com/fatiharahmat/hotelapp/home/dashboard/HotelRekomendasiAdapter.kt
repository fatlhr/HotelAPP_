...
class HotelRekomendasiAdapter(
    private var data: List<Hotel>,
    private val listener: (Hotel) -> Unit)
    : RecyclerView.Adapter<HotelRekomendasiAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ):HotelRekomendasiAdapter.ViewHolder {

        val layoutInflater = LayoutInflater.from(parent.context)
        contextAdapter = parent.context
        val inflatedView : View = layoutInflater.inflate(R.layout.row_item_hotel_rekomendasi, parent, false)

        return ViewHolder(inflatedView)
    }

    override fun onBindViewHolder(holder: HotelRekomendasiAdapter.ViewHolder, position: Int) {
